        ...
        <section className='note-form-section'>
            ...
            <form className='note-form'>
                <div className='form-element'>
                    ...
                    <input type="text" id="noteTitle" name="noteTitle" placeholder="Note title here ..." onChange={onFormDataChange}
                      className="form-control" value = {formData.noteTitle} />
                ...
                <div className='form-element'>
                    ...
                    <textarea id="noteContent" name="noteContent" placeholder="Note Content here ..." onChange={onFormDataChange}
                      className="form-control" rows="10"  value={formData.noteContent} ></textarea>
